...
if [ ! -f "$1" ]; then
   ...
   echo
   echo "The name of ZIP is assumed to have Xtended-XQ-VERSION-DATE-TYPE-* as format"
...
# Assume Xtended-XQ-VERSION-DATE-TYPE-*.zip
...
adb shell "killall com.xtended.updater 2>/dev/null"
adb shell "sqlite3 /data/data/com.xtended.updater/databases/updates.db" \
