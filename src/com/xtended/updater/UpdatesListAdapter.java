...
import com.xtended.updater.controller.UpdaterController;
import com.xtended.updater.controller.UpdaterService;
import com.xtended.updater.misc.BuildInfoUtils;
import com.xtended.updater.misc.Constants;
import com.xtended.updater.misc.PermissionsUtils;
import com.xtended.updater.misc.StringGenerator;
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                while((inputString = in.readLine()) != null) {
                    // don't include the top 2 lines of the changelog
                    if (i >= 2) {
