...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.colt.release.version";
    public static final String PROP_DEVICE = "ro.colt.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.colt.releasetype";
    ...
    public static final String PROP_MAINTAINER = "ro.colt.maintainer";
}
